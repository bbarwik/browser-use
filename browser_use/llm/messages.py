...
class ImageURL(BaseModel):
	"""Image URL specification for vision models."""
	url: str
...
class Function(BaseModel):
	"""Function call specification for tool usage."""
	arguments: str
	"""
...
"""The base type for all message types used in LLM conversations.

A union type that can be UserMessage, SystemMessage, or AssistantMessage."""
